...
Every other holder, including one whose liveness cannot be told, is refused, so a leaked pool slot stays recoverable while a second live copy never shares the branch.
