...
- A secondmate's own row appears Under way only for `active_child_work`; held or unavailable structured-home state is represented through the board's queued or held items unless its reason requires the captain's action.
