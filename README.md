...
- [docs/configuration.md](docs/configuration.md) - environment variables, `FM_HOME`, runtime backend selection, optional Relay and its X and Discord setup steps, the optional GitHub fleet board's setup and sync contract, the files you set, and harness support.
